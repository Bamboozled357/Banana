...
class RegistrationSerializer(serializers.Serializer):
    ...
    #     user = User.objects.create_user(email=email, password=password, name=name, last_name=last_name)
    """можно избежать прописи вручную всех полей как name, password и т.д., а сделать из attrs 
        kwargs т.е. - **attrs:"""
    def create(self, attrs): #attrs может называться и как validated_data
